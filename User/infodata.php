            ...
            ?>
                            <div class="info flex" style="margin-top: 50px; margin-left: 8%; font-size: large;">
                                <div style="width: 450px; height: 125px;">  
                                    ...
                                    Mobile No: <?php echo $row_batch['mobile_No']?><br>
                                    Batch: <?php echo $row_batch['batch']?><br>
                                </div>

                                <div style="margin-left: 0%">
                                    Company: <?php echo $row_batch['company']?><br>
                                    Current Job: <?php echo $row_batch['current_job']?><br>
                                    Package: <?php echo $row_batch['package']?>
                                </div>
                            </div>
                        </div>
            <?php    
