<?php
     if(isset($_POST['generate_pdf_seniorexecutive']))
     {
          function fetch_data1()  
          {  
               $output_student = '';  
               $conn = mysqli_connect("localhost", "root", "Dxun@931", "alumni_Portal");  
               $sql = "SELECT * FROM project WHERE current_job = 'Senior Executive'";  
          ...
          {  
               ...
               $content = '';  
               $content .= '  
               <h4 align="center"> Report For Senior Executive </h4><br /> 
